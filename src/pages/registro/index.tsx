  ...
  return (
    <>
      ...
      <Flex
        ...
        <Box>
          <Image src='https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSbHMTle3JOuS8osC21bVdoEuaXd3nRxao06CFnhE24KoDbv2M7NXnx_F9OuNRIvOjcwDU&usqp=CAU' alt='UVV' />
        </Box>
        </Stack>
        <Stack spacing={8} mx={'20%'} maxW={'lg'} py={12} px={6}>
          <Stack align={'center'}>
